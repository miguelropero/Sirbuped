...
public class RichTextToolbar extends Composite {
	...
	//private static final String HTTP_STATIC_ICONS_GIF = "http://sirbuped1.appspot.com/image/icons.png";
	private static final String HTTP_STATIC_ICONS_GIF = "http://sirbuped1.appspot.com/image/icons.png";
	...
	static {
		GUI_COLORLIST.put("Blanco", "#FFFFFF");
		GUI_COLORLIST.put("Negro", "#000000");
		GUI_COLORLIST.put("Rojo", "red");
		GUI_COLORLIST.put("Verde", "green");
		GUI_COLORLIST.put("Amarillo", "yellow");
	...
	//GUI Related stuff
	private static final String GUI_DIALOG_INSERTURL = "Ingrese la URL del hipervinculo:";
	private static final String GUI_DIALOG_IMAGEURL = "Ingrese la URL de la imgen:";

	private static final String GUI_LISTNAME_COLORS = "Color";
	private static final String GUI_LISTNAME_FONTS = "Fuente";
	
	private static final String GUI_HOVERTEXT_SWITCHVIEW = "Ver HTML";
	private static final String GUI_HOVERTEXT_REMOVEFORMAT = "Remover Formato";
	...
	private static final String GUI_HOVERTEXT_BREAKLINK = "Eliminar Hipervinculo";
	private static final String GUI_HOVERTEXT_LINK = "Insertar Hipervinculo";
	private static final String GUI_HOVERTEXT_IDENTLEFT = "Identar a la Izquierda";
	private static final String GUI_HOVERTEXT_IDENTRIGHT = "Identar a la Derecha";
	private static final String GUI_HOVERTEXT_UNORDERLIST = "Insertar Vi\u0148eta";
	private static final String GUI_HOVERTEXT_ORDERLIST = "Lista Ordenada";
	private static final String GUI_HOVERTEXT_ALIGNRIGHT = "Alinear a la Derecha";
	private static final String GUI_HOVERTEXT_ALIGNCENTER = "Centrar";
	private static final String GUI_HOVERTEXT_ALIGNLEFT = "Alinear a la Izquierda";
	...
	private static final String GUI_HOVERTEXT_STROKE = "Texto Tachado";
	private static final String GUI_HOVERTEXT_UNDERLINE = "Subrayado";
	...
	private void buildTools() {
		...
		topPanel.add(bold = createToggleButton(HTTP_STATIC_ICONS_GIF,5,10,26,24,GUI_HOVERTEXT_BOLD));
		topPanel.add(italic = createToggleButton(HTTP_STATIC_ICONS_GIF,5,38,26,24,GUI_HOVERTEXT_ITALIC));
		topPanel.add(underline = createToggleButton(HTTP_STATIC_ICONS_GIF,33,108,26,24,GUI_HOVERTEXT_UNDERLINE));
		topPanel.add(stroke = createToggleButton(HTTP_STATIC_ICONS_GIF,5,66,26,24,GUI_HOVERTEXT_STROKE));
		topPanel.add(new HTML("&nbsp;"));
		topPanel.add(subscript = createToggleButton(HTTP_STATIC_ICONS_GIF,5,407,26,24,GUI_HOVERTEXT_SUBSCRIPT));
		topPanel.add(superscript = createToggleButton(HTTP_STATIC_ICONS_GIF,5,435,26,24,GUI_HOVERTEXT_SUPERSCRIPT));
		topPanel.add(new HTML("&nbsp;"));
		topPanel.add(alignleft = createPushButton(HTTP_STATIC_ICONS_GIF,5,188,26,24,GUI_HOVERTEXT_ALIGNLEFT));
		topPanel.add(alignmiddle = createPushButton(HTTP_STATIC_ICONS_GIF,5,216,26,24,GUI_HOVERTEXT_ALIGNCENTER));
		topPanel.add(alignright = createPushButton(HTTP_STATIC_ICONS_GIF,5,244,26,24,GUI_HOVERTEXT_ALIGNRIGHT));
		topPanel.add(new HTML("&nbsp;"));
		topPanel.add(orderlist = createPushButton(HTTP_STATIC_ICONS_GIF,5,127,26,24,GUI_HOVERTEXT_ORDERLIST));
		topPanel.add(unorderlist = createPushButton(HTTP_STATIC_ICONS_GIF,5,99,26,24,GUI_HOVERTEXT_UNORDERLIST));
		topPanel.add(indentright = createPushButton(HTTP_STATIC_ICONS_GIF,33,360,26,24,GUI_HOVERTEXT_IDENTRIGHT));
		topPanel.add(indentleft = createPushButton(HTTP_STATIC_ICONS_GIF,33,388,26,24,GUI_HOVERTEXT_IDENTLEFT));
		topPanel.add(new HTML("&nbsp;"));
		topPanel.add(generatelink = createPushButton(HTTP_STATIC_ICONS_GIF,5,277,26,24,GUI_HOVERTEXT_LINK));
		topPanel.add(breaklink = createPushButton(HTTP_STATIC_ICONS_GIF,5,305,25,24,GUI_HOVERTEXT_BREAKLINK));
		topPanel.add(new HTML("&nbsp;"));
		topPanel.add(insertline = createPushButton(HTTP_STATIC_ICONS_GIF,33,210,26,24,GUI_HOVERTEXT_HLINE));
		topPanel.add(insertimage = createPushButton(HTTP_STATIC_ICONS_GIF,33,299,26,24,GUI_HOVERTEXT_IMAGE));
		topPanel.add(new HTML("&nbsp;"));
		topPanel.add(removeformatting = createPushButton(HTTP_STATIC_ICONS_GIF,33,266,26,24,GUI_HOVERTEXT_REMOVEFORMAT));
		topPanel.add(new HTML("&nbsp;"));
		topPanel.add(texthtml = createToggleButton(HTTP_STATIC_ICONS_GIF,33,238,26,24,GUI_HOVERTEXT_SWITCHVIEW));
