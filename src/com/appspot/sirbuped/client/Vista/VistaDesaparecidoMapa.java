...
public class VistaDesaparecidoMapa extends Composite 
{
	private byte indice;
	public VistaDesaparecidoMapa()
	{	
		indice = 0;
				...
				public void onSuccess(LatLng point)
				{
					...
					marker.addMarkerClickHandler(new MarkerClickHandler()
					{
						...
						public void onClick(MarkerClickEvent event) 
						{
							...
							{
								DesaparecidoServiceAsync desaparecidoService = GWT.create(DesaparecidoService.class);
								desaparecidoService.getDesaparecidosDpto(punto[0], 3, new AsyncCallback<ArrayList<Desaparecido>>() 
								{
									public void onSuccess(final ArrayList<Desaparecido> results) 
									{
										...
										HTMLPanel desaparecidos = new VistaDesaparecidoDetallar().mostarTodos(results);
										desaparecidos.setStyleName("verDesaparecido enMapa");
										Hyperlink verTodos = new Hyperlink("Ver todos", false, "_desaparecidos-en-" + punto[0]);
